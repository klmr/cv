...
\begin{sidebar}
    ...
    \subsection{Analysis}
    \details{Data exploration, data visualisation, statistical modelling,
        RNA-seq, ChIP-seq, motif analysis}
    ...
    \details{Software development team lead, EMBL PhD Symposium organising
        committee, EMBL Bioinformatics Workshop coordination}
\end{sidebar}

\section{Research}

\subsection{EMBL-EBI\date{2015--2016}}
