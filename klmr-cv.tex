...
\entry{Generic parallelisation of a sequence analysis library\date{2010--2011}}
...
\entry{Implementation of a tool for T-invariant analysis in Petri nets of
    biochemical pathways\date{2009}}
\details{\subsubsection{Group leader:} Prof Dr Ina Koch}

\entry{Implementation of a read mapping tool based on the pigeon-hole
    principle\date{2008}}
\details{\subsubsection{Group leader:} Prof Dr Knut Reinert}
